...
class AdminShippingDetails extends StatelessWidget {
      ...
      children: [
        ...
        Padding(
          ...
          child: Center(
            child: InkWell(
              onTap: () {
                confirmedParcelShiftedd(context, getOrderId);
              },
              child: Container(
  ...
  confirmedParcelShiftedd(BuildContext context, String nOrderId) {
    EcommerceApp.firestore
        .collection(EcommerceApp.collectionOrders).document(nOrderId)
        .delete()
        .whenComplete(() {
      getOrderId = "";
